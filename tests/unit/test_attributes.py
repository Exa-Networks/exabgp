...
def mock_logger() -> Generator[None, None, None]:
    ...
    with patch('exabgp.bgp.message.update.attribute.collection.log') as mock_log:
        mock_log.debug = Mock()
        yield
...
def test_attributes_parse_origin_transitive() -> None:
    ...
    attributes = AttributeCollection.unpack(data, negotiated)
...
def test_attributes_zero_length_as_path_valid() -> None:
    ...
    AttributeCollection.unpack(data, negotiated)
...
def test_attributes_has_method() -> None:
    """Test AttributeCollection.has() method."""
    from exabgp.bgp.message.update.attribute.collection import AttributeCollection
    from exabgp.bgp.message.update.attribute.origin import Origin
...
def test_attributes_remove_method() -> None:
    """Test AttributeCollection.remove() method."""
    from exabgp.bgp.message.update.attribute.collection import AttributeCollection
    from exabgp.bgp.message.update.attribute.origin import Origin
