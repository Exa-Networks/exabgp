...
class TestHashTable:
    ...
    def test_hashtable_setitem(self):
    ...
    def test_hashtable_getitem(self):
    ...
    def test_hashtable_setattr(self):
    ...
    def test_hashtable_getattr(self):
    ...
    def test_hashtable_no_underscore(self):
    ...
    def test_hashtable_multiple_underscores(self):
...
class TestGlobalHashTable:
    ...
    def test_globalhash_singleton(self):
    ...
    def test_globalhash_shared_state(self):
    ...
    def test_globalhash_inheritance(self):
...
class TestBase:
    ...
    def test_application_constant(self):
    ...
    def test_find_root_from_argv(self, mock_env_get):
    ...
    @patch('os.environ.get')
    def test_find_root_from_env(self, mock_env_get):
    ...
    @patch('os.environ.get')
    @patch('sys.argv', ['/usr/local/bin/exabgp'])
    def test_find_root_strips_bin(self, mock_env_get):
    ...
    def test_find_root_strips_app_folder(self, mock_env_get):
    ...
    def test_find_root_strips_trailing_slash(self, mock_env_get):
