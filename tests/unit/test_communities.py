...
def test_standard_community_parsing() -> None:
    ...
    assert community.pack_attribute(create_negotiated()) == community_bytes
...
def test_route_target_asn2_number() -> None:
    ...
    packed = rt.pack_attribute(create_negotiated())
    assert len(packed) == 8
...
def test_route_target_transitive_flag() -> None:
    ...
    packed_trans = rt_transitive.pack_attribute(create_negotiated())
    ...
    packed_non_trans = rt_non_transitive.pack_attribute(create_negotiated())
...
def test_extended_community_base_parsing() -> None:
    ...
    assert len(ec) == 8
    assert ec.pack_attribute(create_negotiated()) == unknown_data
...
def test_route_origin_community() -> None:
    ...
    packed = ro.pack_attribute(create_negotiated())
...
def test_bandwidth_community() -> None:
    ...
    # Verify pack/unpack
    packed = bw.pack_attribute(create_negotiated())
    # Bandwidth.pack_attribute(create_negotiated()) returns only the data (ASN + float), not full extended community
    assert len(packed) == 6
...
def test_encapsulation_community_vxlan() -> None:
    ...
    # Verify pack/unpack
    packed = encap.pack_attribute(create_negotiated())
    assert len(packed) == 8
...
def test_traffic_engineering_community() -> None:
    ...
    # Verify pack
    packed = tr.pack_attribute(create_negotiated())
    assert len(packed) == 8
...
def test_l2info_community() -> None:
    ...
    # Verify pack/unpack
    packed = l2info.pack_attribute(create_negotiated())
...
def test_mac_mobility_community() -> None:
    ...
    # Verify pack/unpack
    packed = mac_mob.pack_attribute(create_negotiated())
...
def test_large_community_parsing() -> None:
    ...
    # Verify pack round-trip
    assert lc.pack_attribute(create_negotiated()) == large_bytes
