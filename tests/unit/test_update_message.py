...
def test_update_attribute_order_independence() -> None:
    ...
    result1 = UpdateCollection.unpack_message(data1, negotiated)
    result2 = UpdateCollection.unpack_message(data2, negotiated)

    # Both should parse successfully
    assert isinstance(result1, UpdateCollection)
    assert isinstance(result2, UpdateCollection)
