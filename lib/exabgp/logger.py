...
class Logger (object):
	...
	# show the message on the wire
	def network (self, message, recorder='debug', source='network', log='network'):
	...
	def message (self, message, recorder='debug', source='message', log='message'):
		self._generic(message,recorder,source,log)

	# show the parsing of the configuration
	def configuration (self, message, recorder='debug', source='configuration', log='configuration'):
		self._generic(message,recorder,source,log)

	# show the exchange of message generated by the reactor (^C and signal received)
	def reactor (self, message, recorder='debug', source='reactor', log='reactor'):
		self._generic(message,recorder,source,log)

	# show the change of rib table
	def rib (self, message, recorder='debug', source='rib', log='rib'):
		self._generic(message,recorder,source,log)
	...
	def daemon (self, message, recorder='debug', source='daemon', log='daemon'):
		self._generic(message,recorder,source,log)

	# show the exchange of message generated by the forked processes
	def processes (self, message, recorder='debug', source='processes', log='processes'):
		self._generic(message,recorder,source,log)

	# show the exchange of message generated by the routes received
	def routes (self, message, recorder='debug', source='routes', log='routes'):
		self._generic(message,recorder,source,log)

	# show how the message received are parsed
	def parser (self, message, recorder='debug', source='parser', log='parser'):
		self._generic(message,recorder,source,log)
