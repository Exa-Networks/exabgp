...
OriginASNIP._known[chr(OriginASNIP.COMMUNITY_TYPE&0x0F)+chr(OriginASNIP.COMMUNITY_SUBTYPE)] = OriginASNIP
...
OriginIPASN._known[chr(OriginIPASN.COMMUNITY_TYPE&0x0F)+chr(OriginIPASN.COMMUNITY_SUBTYPE)] = OriginIPASN
...
OriginASN4Number._known[chr(OriginASN4Number.COMMUNITY_TYPE&0x0F)+chr(OriginASN4Number.COMMUNITY_SUBTYPE)] = OriginASN4Number
