...
- EXA_STYLE.md - Safety rules, MANDATORY, enforced by qa/bin/check_exa_style
...
├── CODING_STANDARDS.md
├── EXA_STYLE.md                      # 🐯 MANDATORY safety rules
├── TESTING_PROTOCOL.md
├── PLANNING_GUIDE.md
├── CI_TESTING.md
...
---------|---------------------|----------------------
Fix a bug | exabgp/CODEBASE_ARCHITECTURE.md (summary in ESSENTIAL) | EXA_STYLE.md
Decode wire data | doc/RFC_WIRE_FORMAT_REFERENCE.md, exabgp/DATA_FLOW_GUIDE.md | EXA_STYLE.md
...
1. Make changes following CODING_STANDARDS.md and EXA_STYLE.md
