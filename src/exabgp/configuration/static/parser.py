...
def _extended_community_hex(value: str) -> ExtendedCommunity:
    ...
    return ExtendedCommunity.unpack_attribute(raw)  # type: ignore[return-value]
...
def _extended_community(value: str) -> ExtendedCommunity:
    ...
    return ExtendedCommunity.unpack_attribute(header + pack(packed, *components))  # type: ignore[return-value]
