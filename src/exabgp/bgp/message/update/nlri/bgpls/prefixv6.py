...
class PREFIXv6(BGPLS):
    ...
    def __init__(
        ...
        """Create PREFIXv6 with complete wire format.
    ...
    @classmethod
    def unpack_bgpls_nlri(cls, data: Buffer, rd: RouteDistinguisher | None) -> PREFIXv6:
        """Unpack PREFIXv6 from complete wire format.
